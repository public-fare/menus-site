...
{% for author in page.authors %}
    <li>{{ author.name }}, <a href="https://twitter.com/{{ author.handle}}">@{{ author.handle}}</a></li>
{% endfor %}
</ul>
